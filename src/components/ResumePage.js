...
export default function ResumePage() {
    ...
    const KorotuDesc = "For my first co-op workterm, I worked at Korotu Technology as a Software Engineer (Full-Stack) and Artificial Intelligence Researcher Intern. Korotu's vision is to create a solution that aids landowners in protecting and repairing their land. Over the course of four months, I was responsible for optimizing and adding additional functionality to the backend codebase, creating and styling several frontend pages, and desgining the entire UI/UX of the product. It was a wonderful time working for Korotu and I am honoured to know that my work will provide the foundation to a great product with an even greater potential for positive change!"
